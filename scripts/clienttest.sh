...
/sbin/setuser app bin/behat --stop-on-failure --config=tests/behat/behat.yml --suite=deputy --profile=${PROFILE:=headless}
/sbin/setuser app bin/behat --stop-on-failure --config=tests/behat/behat.yml --suite=deputyodr --profile=${PROFILE:=headless}
/sbin/setuser app bin/behat --stop-on-failure --config=tests/behat/behat.yml --suite=pa --profile=${PROFILE:=headless}